...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("Particles test", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		if (gWindow == nullptr)
		{
...
int main(int argc, char* args[])
{
	...
	else
	{
		...
		{	//Main loop flag
			...
			//Initialze the rest of the windows
			/*
